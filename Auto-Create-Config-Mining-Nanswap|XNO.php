...
sleep(1);
echo "cd xmrig-6.22.2 && ./xmrig -o xmrig.nanswap.com:3333 -a rx -k -u $xno -p x -t 64 --cpu-priority=5 --cpu-memory-pool=-1 --huge-pages-jit --randomx-mode=fast --randomx-1gb-pages \n\n";

echo "$cyan           [_--$hijau Menggunakan API key$cyan _--]$hijau \n\n";

echo "cd xmrig-6.22.2 && ./xmrig -o xmrig.nanswap.com:3333 -a rx -k -u $xno -p x -t 64 --cpu-priority=5 --cpu-memory-pool=-1 --huge-pages-jit --randomx-mode=fast --randomx-1gb-pages --api-id=$id \n\n";
